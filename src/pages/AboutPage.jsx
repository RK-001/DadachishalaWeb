            ...
            <div className="bg-gradient-to-r from-primary-500 to-primary-600 rounded-2xl p-8 md:p-12 text-prim shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group border-2 border-primary-700">
              <div className="text-center max-w-4xl mx-auto">
                ...
                <div className="space-y-4 text-white leading-relaxed text-lg">
                  <p>
                    Our journey has been recognized widely, thanks to the unwavering support of <strong className="text-white">Dr. Sindhutai Sapkal (Maai)</strong>, extensive media coverage, and local newspapers. Their belief in our mission has amplified our voice and helped us gain mass recognition, furthering our efforts in education and child welfare.
                  </p>
