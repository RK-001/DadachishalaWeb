...
import { 
  ...
  export const getEvents = async (limitCount = null) => {
    ...
    const cached = cacheService.get('events', params);
    ...
    try {
      ...
      cacheService.set('events', data, params);
      return data;
    } catch (error) {
  ...
  export const getUpcomingEvents = async (limitCount = 3) => {
    const params = { upcoming: true, limit: limitCount };
    const cached = cacheService.get('events', params);
    if (cached !== null) return cached;
  ...
  export const getGalleryItems = async (category = null, limitCount = null) => {
    const params = { category, limit: limitCount };
    const cached = cacheService.get('gallery', params);
    if (cached !== null) return cached;
    ...
    try {
      ...
      cacheService.set('gallery', items, params);
      return items;
    } catch (error) {
  ...
  export const getSuccessStories = async () => {
    const cached = cacheService.get('successStories');
    if (cached !== null) return cached;
    ...
    try {
      ...
      cacheService.set('successStories', data);
      return data;
    } catch (error) {
  ...
  export const getTestimonials = async () => {
    ...
    try {
      ...
      cacheService.set('testimonials', data);
      return data;
    } catch (error) {
  ...
  export const getBlogs = async (authorType = null, limitCount = null) => {
    const params = { authorType, limit: limitCount };
    const cached = cacheService.get('blogs', params);
    if (cached !== null) return cached;
    ...
    try {
      ...
      cacheService.set('blogs', data, params);
      return data;
    } catch (error) {
  ...
  export const getBranches = async () => {
    const cached = cacheService.get('branches');
    if (cached !== null) return cached;
    ...
    try {
      ...
      cacheService.set('branches', data);
      return data;
    } catch (error) {
  ...
  export const getBranchById = async (branchId) => {
    ...
    const cached = cacheService.get('branches', params);
    if (cached !== null) return cached;
    ...
    try {
      ...
      if (branchSnap.exists()) {
        ...
        cacheService.set('branches', data, params);
        return data;
      } else {
  ...
  export const getAwards = async (limitCount = null) => {
    const params = { limit: limitCount };
    const cached = cacheService.get('awards', params);
    if (cached !== null) return cached;
    ...
    try {
      ...
      cacheService.set('awards', data, params);
      return data;
    } catch (error) {
  ...
  export const getNewsArticles = async (limitCount = null) => {
    const params = { limit: limitCount };
    const cached = cacheService.get('news', params);
    if (cached !== null) return cached;
    ...
    try {
      ...
      cacheService.set('news', data, params);
      return data;
    } catch (error) {
  ...
  export const getVideos = async (limitCount = null) => {
    const params = { limit: limitCount };
    const cached = cacheService.get('videos', params);
    if (cached !== null) return cached;
    ...
    try {
      ...
      cacheService.set('videos', data, params);
      return data;
    } catch (error) {
  ...
  export const getVolunteers = async () => {
    const cached = cacheService.get('volunteers');
    if (cached !== null) return cached;
    ...
    try {
      ...
      cacheService.set('volunteers', data);
      return data;
    } catch (error) {
  ...
  export const getVolunteersByStatus = async (status) => {
    const params = { status };
    const cached = cacheService.get('volunteers', params);
    if (cached !== null) return cached;
    ...
    try {
      ...
      cacheService.set('volunteers', data, params);
      return data;
    } catch (error) {
  ...
  export const getDonations = async (limitCount = null) => {
    const params = { limit: limitCount };
    const cached = cacheService.get('donations', params);
    if (cached !== null) return cached;
    ...
    try {
      ...
      cacheService.set('donations', data, params);
      return data;
    } catch (error) {
  ...
  export const getDonationStats = async () => {
    const cached = cacheService.get('stats', { type: 'donations' });
    if (cached !== null) return cached;
    ...
    try {
      ...
      cacheService.set('stats', data, { type: 'donations' });
      return data;
    } catch (error) {
  ...
  export const getCollectionCount = async (collectionName) => {
    const cached = cacheService.get('stats', { type: 'count', collection: collectionName });
    if (cached !== null) return cached;
  
    try {
      const querySnapshot = await getDocs(collection(db, collectionName));
      const count = querySnapshot.size;
      cacheService.set('stats', count, { type: 'count', collection: collectionName });
      return count;
    } catch (error) {
